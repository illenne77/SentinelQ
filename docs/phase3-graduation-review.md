...
| ⏳ 미착수 | G2, G6 | 본인 실제 신고 데이터 / 자기평가 문서 필요 |
...
### G6 — 본인 사용 가치 연 50만원+ ⏳ 미착수

- **정본 정의**: 본인 사용 가치 연 50만원+ 입증 — **Phase 2 시작 전 자기 평가
  문서 작성**
- **상태**: 자기 평가 문서 미작성. ADR-0013 §Method 기대값 base case는 본인 사용
  가치를 연 55~370만원으로 추정하나, 게이트는 **사후 자기 평가**를 요구한다.
- **미착수 사유**: 본 게이트는 G1~G3 실증으로 도구의 실사용 가치가 확인된 뒤
  작성하는 것이 의미 있다.
...
| 단계 | 요구 게이트 | 현재 |
|---|---|---|
| Phase 1 완료 인정 | G1 + G2 + G3 | ❌ 미충족 — 3개 모두 실증 대기 |
| Phase 2 진행 결정 | G1 + G2 + G3 + G6 | ❌ 미충족 |
